...
class VLNBert(nn.Module):
    def __init__(self, args):
        ...
        self.vln_bert = get_vlnbert_models(args, config=None)  # initialize the VLN-BERT(visual and language model)
    ...
    def forward(self, mode, batch):
        ...
        if mode == 'language':
            ...
            pano_embeds, pano_masks, sim = self.vln_bert(mode, batch)
            return pano_embeds, pano_masks, sim
