...
sys.path.append('./HSPR-main/reasoning_nav_src')
import torch
...
from r2r.data_utils import ObjectFeatureDB, construct_instrs
...
def build_dataset(args, rank=0, is_test=False):
    ...
    train_env = dataset_class(
        ...
        angle_feat_size=args.angle_feat_size, max_objects=args.max_objects, seed=args.seed + rank,
    ...
    for split in val_env_names:
        ...
        val_env = dataset_class(
            feat_db, obj_db, val_instr_data, args.connectivity_dir, batch_size=args.batch_size,
